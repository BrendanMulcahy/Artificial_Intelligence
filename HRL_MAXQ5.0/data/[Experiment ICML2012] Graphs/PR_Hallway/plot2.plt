...
plot 'Hallway-BMaxQPrBayes-5000-avg5.rl' using 1:2 title 'B-MaxQ Bayes PR' with linespoints pi 200 lt 5 pt 5 lw 2, \
	...
	'Hallway-MaxQPrNo-5000-avg5.rl' using 1:2 title 'MaxQ No PR' with linespoints pi 100 lt 8 pt 8 lw 2, \
